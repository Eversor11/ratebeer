...
describe "beerlist page" do
  ...
  it "orders by name on default", js: true do
    visit beerlist_path
  ...
  it "orders by style name when clicking style", js:true do
    visit beerlist_path
    click_link 'Style'
  ...
  it "orders by brewery name when clicking brewery", js:true do
    visit beerlist_path
    click_link 'Brewery'
